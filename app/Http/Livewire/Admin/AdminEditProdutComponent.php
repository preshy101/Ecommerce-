...
class AdminEditProdutComponent extends Component
{
    use WithFileUploads;
    public $name;
    public $slug;
...
public function remove($attr){
 unset($this->inputs[$attr]);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-edit-produt-component',['categories'=>$categories,'scategories'=>$scategories, 'pattributes'=>$pattributes])->layout('layouts.base');
    }
}
