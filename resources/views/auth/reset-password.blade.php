...
<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>Reset passsword</span></li>
        </ul>
    </div>
    <div class="row">
                ...
                <div class="wrap-login-item ">
                    ...
                    <form name="frm-login" method="POST" action="{{route('password.update')}}">
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="email" id="frm-login-uname" name="email" placeholder="Type your email address" :value="{{$request->mail}}" required autofocus>
                            </fieldset>
