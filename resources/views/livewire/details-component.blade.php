        ...
        width: 100%;
				...
				<div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="wrap-show-advance-info-box style-1">
						<h3 class="title-box" style="width: 100%;">Related Products</h3>
								...
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('product.details',['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
											<figure><img src="{{ asset('assets/images/products/')}}/{{$r_product->image}}" style=" width: 214px; height: 214px;"  alt=" {{$r_product->name}}"></figure>
										</a>
