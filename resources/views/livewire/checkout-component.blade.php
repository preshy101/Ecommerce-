            ...
            <h3 class="box-title">Billing Address</h3>
              <div class="billing-address">
                ...
                <p class="row-in-form">
                    ...
                    <input  type="text" name="country" value="" placeholder="Nigeria" wire:model="country">
    ...
    @if($paymentmode =='card')
               ...
               <p class="row-in-form">
                ...
                <p class="row-in-form">
                    ...
                    <input  type="password" class="passs" name="zip-code" value="" placeholder="cvc"wire:model="cvc">
               ...
               @if($errors->isEmpty())
               <div wire:ignore id="processing" class="" style="font-size: 22px;margin-bottom: 20px;padding-left: 37px;color:green; display: none;">
