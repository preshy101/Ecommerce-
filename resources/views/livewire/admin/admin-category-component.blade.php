                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="sclist">
                                    ...
                                    <li><i class="fa fa-caret-right"></i> {{$scategory->name}}  <a href="{{route('admin.editcategory',['category_slug'=>$category->slug,'scategory_slug'=>$scategory->slug])}}" style="font-size: 16px; margin-left:12px; margin-right: 10px;"> <i class="fa fa-edit"></i></a>
