            ...
            <div class="checkout-info">
                ...
                <div class="summary-item">
                    <form action="" wire:submit.prevent="applyCouponCode">
                       ...
                       @endif
                        <p class="row-in-form">
                            <label for="" class="coupon-coe">Enter your coupon code</label>
...
@endif
        ...
        <div class="wrap-item-in-cart">
            <h3 class="title-box" style="border-bottom: 1px sold; padding-bottom: 15px;"> {{Cart::instance('saveForLater')->count()}} item(s) Saved for Later</h3>
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="delete">
                        <a href="#" class="btn btn-delete" title="" wire:click.prevent="deleteFromSavedForLater('{{$item->rowId}}')">
